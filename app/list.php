...
<div class="mt-4 mb-1">
    <div class="text-right d-print-none">
        <a href="javascript:window.print()" class="btn btn-primary waves-effect waves-light"><i class="fas fa-print mr-1"></i> Print List</a>
    </div>
</div>

			<h2>List of Houses / Apartments Details</h2>
								  ...
								  <div class="card-block">';
									 ...
									 echo 	'<div class="row">
											...
											<h4 class="text-center">Owner Details</h4>';
											 	echo '<p><b>Property Name: </b>'.$value['fullname'].'</p>';
										...
										echo '</div>
											...
											<h4 class="text-center">Room Details</h4>';
												echo '<p><b>Property Type: </b>'.$value['property_type'].'</p>';
...
<style>
    ...
    /* Optionally, you can customize the printed page layout */
    body {
