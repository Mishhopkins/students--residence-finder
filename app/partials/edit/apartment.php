  		...
  		<form action="" method="POST">
		  	 <div class="row">
		  	 	<div class="col-md-4">
				    ...
				    <label for="fullname">Apartment Name</label>
				...
				<div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" pattern="^(\d{10})$" id="alternat_mobile" title="10 digit mobile number" placeholder="10 digit mobile number" name="alternat_mobile" value="<?php echo $data['alternat_mobile']?$data['alternat_mobile']:''; ?>">
				  </div>
				</div>
			</div>
			...
			<div class="row">
			 ...
			 <div class="row">
			  ...
			  <div class="form-group">
			    ...
			    <input type="location" class="form-control" id="location" placeholder="Location" name="location" value="<?php echo $data['location']?$data['location']:''; ?>" required>
			  </div>
			   </div>
			    </div>
