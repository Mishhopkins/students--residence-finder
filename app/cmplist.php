...
<div class="mt-4 mb-1">
    <div class="text-right d-print-none">
        <a href="javascript:window.print()" class="btn btn-primary waves-effect waves-light"><i class="fas fa-print mr-1"></i> Print Complaint List</a>
    </div>
</div>
	...
	<div class="container">
		<div class="row">
			...
			?>
			<h2>List of Apartment / House Complaints</h2>
				<?php 
